...
def main():
    ...
    np.savetxt("NEW-PVP-final-AAC-LOO-probas_y.csv", loo_probas_y, delimiter=",")
    np.savetxt("NEW-PVP-final-AAC-LOO-predict_y.csv", loo_predict_y, delimiter=",")
    np.savetxt("NEW-PVP-final-AAC-LOO-test_y.csv", loo_test_y, delimiter=",")
