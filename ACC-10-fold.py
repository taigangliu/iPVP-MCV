...
def main():
    ...
    np.savetxt("NEW-10fold-PVP-final-AAC-probas_y.csv", loo_probas_y, delimiter=",")
    np.savetxt("NEW-10fold-PVP-final-AAC-predict_y.csv", loo_predict_y, delimiter=",")
    np.savetxt("NEW-10fold-PVP-final-AAC-test_y.csv", loo_test_y, delimiter=",")
    ...
    #np.savetxt("NEW-PVP-final-AAC-IND-probas_y.csv", probas_y, delimiter=",")
    #np.savetxt("NEW-PVP-final-AAC-IND-predict_y.csv", predict_y, delimiter=",")
    #np.savetxt("NEW-PVP-final-AAC-IND-test_y.csv", test_y, delimiter=",")
